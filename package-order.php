...
$singlePackage = $GPPackage->singlePackageDetails($packageType); 
// print_r($singlePackage);
...
if(isset($_POST['btnSubmit'])){
    ...
    $insertPackData = $gp->insertPackageOrder($package_id,$niche, $customerId, $customerName, $customerEmail,$customerAddr,$customerZip, $customerCntry, $customerNotes, $paymentType, $paypal_ordKey, $cc_ordered_key, $status, $orderStatus);
                ...
                <div class="row m-0">
                    <div class="col-lg-6 contact_right_row">
                        ...
                        <p class="price-box-title text-center billing-head">Package : <span
                                id="package_id"><?php echo $singlePackage['package_type'];  ?></p>
                        <div class="what-client-choose">
                            ...
                            <ul class="">
                                <li class="package-p"><i class="far fa-check-circle"></i><span class="dollar">
                                        Cost : $</span> <span
                                        id="singlePackagePrice"><?php echo $singlePackage['price'];  ?></span>
                                </li>
                                <?php
                                $features = $GPPackage->featureByPackageId($singlePackage['id']);
                                foreach($features as $feature){
                                    echo '<li class="package-p">
                    ...
                    <div class="col-lg-6 contact_left_row">
                        ...
                        <div class="ifloggedIn">
                            ...
                            <form action="" method="post" id="billingForm">
                                ...
                                <input type="hidden" name="package-type" value="<?php echo $singlePackage['id'];  ?>">
                                <input type="hidden" name="niche" value="<?php echo $niche;  ?>">
                                <input type="hidden" name="amount" value="<?php echo $singlePackage['price'];  ?>">
    ...
    const ccAvenueOrder = () => {
        ...
        if (cb.checked == true) {
            ...
            document.getElementById('billingForm').action =
                `${host}/leelija.in4.0/payments/packagePayments/ccAvenue-payment/payment.php`;
            document.getElementById('billingForm').submit();
        } else {
            document.getElementById('acceptForm').classList.remove('d-none');
        ...
        $("#btnLogin").click(function(e) {
            ...
            $.ajax({
                ...
                success: function(message) {
                    ...
                    if (result1.includes('success') && result2 != 0) {
                        // $(".packLog-h1").css("display", "block");
