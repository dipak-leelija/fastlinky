    ...
    <div class="blogger-banner  banner">
        ...
        <div class="wd_heading_details_2">
            ...
            <p class="mt-4">
                ...
                distributing informative, unique, valuable, well understood and proper content to attract the readers
                and visitors, so that it can be profitable to driving customers on the website. Content is used to
                attract the attention of the readers, to increase customer base, to expand brand awareness, to develop
        ...
        <p class="text-justify service-heading-details">With the help of Content marketing, you can able to show your
            valuable and informative thoughts and ideas with the customers. Here are some examples of content marketing
            :
        </p>
            ...
            <div class="container">
                <div class="row align-items-center m-0">
                    ...
                    <div class="col-lg-6">
                        ...
                        <p class="social-media-point"> Most people think the types of content marketing are the starting
                            point and blogging helps to drag visitors with useful information. Hupspot, buffer, Rip Curl
            ...
            <div class="container">
                <div class="row align-items-center m-0">
                    ...
                    <div class="col-lg-6">
                        ...
                        <p class="social-media-point">Glossier, Intrepid Travel, Superdrug, GE, John Deere, and AARP are
                            the example of social media content marketing. Social media content marketing indirectly
                            helps to grow search ranking and many companies have their focused on social media content
                            marketing. Those companies are the great example of business to business content marketing.
                            They share their thoughts on social sites like Instagram, Facebook, Twitter, Snapchat, etc.
            ...
            <div class="container">
                <div class="row align-items-center m-0">
                    ...
                    <div class="col-lg-6">
                        ...
                        <p class="social-media-point">Zomato, Shutterstock, Rolex, Amazon, Flipcart, etc are the example
                            ...
                            creating and sharing particular and perfect I images. Shutterstock is the business of huge
                            images and this site able to attract billion of visitors in their site. Amazon and Flipcart
        ...
        <div class="container">
            ...
            <div class="wd_heading_details_2">
                ...
                <p class="mt-4 mb-4">
                    ...
                    keywords that many people try to search on social media. You should know the audience mind and know
                    when and where to post your content. Should keep in mind that the content must be valuable and
                    informative that can get more attention from the audience. it is important to mix up your content
                    with text, images, videos and graphics and experiment.
                    Not only focus on the search engine but also focus on people that what they try to search on Google,
                    once you able to read the mind of readers then you will be very successful content writer. And at
            ...
            <div class="wd_heading_details_2">
                ...
                <p class="mt-4 mb-4">
                    ...
                    successful digital marketing companies. Informative and relevant content connected with the success
            ...
            <div class="row align-items-center m-0">
                ...
                <div class="col-lg-6">
                    <div class="right-ul-section">
                        ...
                        <p class="mb-5">Content marketing builds the reputation of many businesses by its quality of
                            ...
                            customers and it helps to gain positive reputation. With the help of great content you can
                            earn trust from your customers as your customers read your content and know the opinion of
                            the brand. If in the content they see the educational and informative ideas then they can
                ...
                <div class="col-lg-6">
                    <div class="right-ul-section">
                        ...
                        <p class="mb-5">Content marketing is important to improve website conversation and it provides
                            high conversation rate than other marketing methods. After reading submissions on the blog
                            many online customers decides to purchase it. Content marketing has increased marketing
                            leads in many companies and it helps to improve conversation because it allows connecting
                ...
                <div class="col-lg-6">
                    <div class="right-ul-section">
                        ...
                        <p class="mb-5">Content marketing plays an important role to build your business and increase
                            search engine optimization. This search engine optimization helps you to show your business
                            online, so you need optimize content to improve SEO. If you have many contents on your sites
                            then the more pages search engine has to index. Thus it easily shows to the users in their
                            searching result. </p>
                ...
                <div class="col-lg-6">
                    <div class="right-ul-section">
                        ...
                        <p class="mb-5">Content marketing is important because it helps you to bring your business in
                            new leads. It boosts to grow your brands and helps to sales the products and it is essential
                            for growing small business. It three time produce many lead and paid search ads. </p>

                    </div>
                </div>
                <div class="col-lg-6 pl-0">
                    <img src="images/OffPageSEO_Services.png" alt="Effective way to bring in new leads" class="w-100">
                </div>
                ...
                <div class="col-lg-6 pl-0">
                    <img src="images/relationship-customer.png" alt="Build relationship with customers" class="w-100">
                </div>
                <div class="col-lg-6">
                    <div class="right-ul-section">
                        ...
                        <p class="mb-5">Content marketing build relationship between blogger and customers and royal
                            ...
                            With those important discussions, you can understand that why is content marketing important
                            to start a business. You should work on increasing on content marketing strategy that can
            ...
            <ul class="faq-body">
                ...
                <li class="faq-li">
                    ...
                    <div class="faq-details">
                        <p>
                            Content marketing is a beneficial marketing method that basically focused on creating and
                ...
                <li class="faq-li">
                    ...
                    <div class="faq-details">
                        <p>Creative content marketing is significantly more than blog posts and website content,
                            incorporating everything from the social media content, to photographs and custom pictures
                            like infographics, and even sound and video. That implies unlimited opportunities for
                            inventive, creative employments of content marketing for brands, everything being equal.</p>
                    </div>
                </li>
                ...
                <li class="faq-li">
                    ...
                    <div class="faq-details">
                        <p>There are many ways to do content marketing such as you should have a proper plan, know what
                ...
                <li class="faq-li">
                    ...
                    <div class="faq-details">
                        <p>SEO and content marketing is highly related to each other as SEO shares a symbiotic
                            connection with content marketing. Though SEO is a technical process it ensures traffic to
                            your website. Content marketing uses attractive contents that are initiative to connect the
                            audience.</p>
                    </div>
                </li>
                ...
                <li class="faq-li">
                    ...
                    <div class="faq-details">
                        <p>It is very important to use right keywords in the content for your website. If you use good
                            and relevant keywords it can ensure that your webpage would rank high on SERPs. However, it
                            is equally important that do not over use the relevant keywords in the overall content. When
                ...
                <li class="faq-li">
                    ...
                    <div class="faq-details">
                        <p> Quality content has a higher probability of getting indexed and ranking higher soon as
                            compared to the low-quality content. We develop content keeping in mind all the necessary
