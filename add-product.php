                            ...
                            <form class="form-horizontal" role="form" action="<?php echo $_SERVER['PHP_SELF'] ?>"
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <select id="txtProdTypeId" class="form-control" name="txtProdTypeId"
                                                required>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <label class="control-label col-md-2" for="txtProdName">Product name:<span
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <label class="control-label col-md-2" for="txtBandName">Band Name:<span
                                                class="orangeLetter"> </label>
                                        <div class="col-md-10">
                                        ...
                                        <div class="col-md-6">
                                            <div class="row">
                                                <label class="control-label col-md-4"
                                                    for="txtPlatForm">Platform:</label>
                                                <div class="col-md-8">
                                                    <select id="txtPlatForm" class="form-control" name="txtPlatForm"
                                                        required>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" id="txtversion"
                                                        name="txtversion"
                                                        value="<?php $utility->printSess2('txtversion',''); ?>"
                                                        required />
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <label class="control-label col-md-2" for="txtULangues">Using Langues:<span
                                                class="orangeLetter"> </label>
                                        <div class="col-md-10">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <label class="control-label col-md-2" for="txtDemoUrl">Demo Url:<span
                                                class="orangeLetter"> </label>
                                        <div class="col-md-10">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <label class="control-label col-md-2" for="txtMetaDesc">Brief:<span
                                                class="orangeLetter"> </label>
                                        <div class="col-md-10">
                                            <textarea type="text" class="form-control" id="txtMetaDesc"
                                                name="txtMetaDesc" rows="5"
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <label class="control-label col-md-2" for="txtDesc">Description:<span
                                                class="orangeLetter"> </label>
                                        <div class="col-md-10">
                                            <textarea type="text" class="form-control" id="txtDesc" name="txtDesc"
                                                rows="5" value="<?php $utility->printSess2('txtDesc',''); ?>">
											</textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="row">
                                                <label class="control-label col-md-4" for="txtServicePrd">Service
                                                    Period:</label>
                                                <div class="col-md-8">
                                                    <input type="text" class="form-control" id="txtServicePrd"
                                                        name="txtServicePrd"
                                                        value="<?php $utility->printSess2('txtServicePrd',''); ?>"
                                                        required />
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <label class="control-label col-md-2" for="txtServices">Services Details:<span
                                                class="orangeLetter"> </label>
                                        <div class="col-md-10">
                                            <textarea type="text" class="form-control" id="txtServices"
                                                name="txtServices" rows="5"
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <label class="control-label col-md-2" for="field1">Product Featured:<span
                                                class="orangeLetter"> </label>
                                        <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <label class="control-label col-md-2" for="txtMtags">Tags:<span
                                                class="orangeLetter"> </label>
                                        <div class="col-md-10">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <button type="submit" name="btnAddProduct" class="add-project">Add For
                                            Sell</button>
                                    </div>
                                    <div class="form-group col-md-4">
                                        <a href="account.php" class="btn btn-warning btn-sm btn-block"
