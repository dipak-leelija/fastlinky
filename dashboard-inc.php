...
<div class="navi mt-4">
    ...
    <ul>
        ...
        <li
            class="<?= ($activePage == 'my-orders.php' || $activePage == 'guest-post-order-list.php' || $activePage == 'package-order-history.php' || $activePage == 'package-order-list.php') ? 'active-styling':''; if($activePage == 'guest-post-article-submit.php'){echo 'active-styling';}  ?>">
