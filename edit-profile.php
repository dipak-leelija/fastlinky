                    ...
                    <div class="row">
                        <div class="bfrom">
                                    ...
                                    <table class="ordered-details-table-css w-100">
                                        <tbody style="vertical-align: baseline;text-align: start;">
                                            <tr>
                                                <td>Name</td>
                                                <td>:</td>
                                                <td class="text-start"><?php echo $cusDtl[0][5].' '.$cusDtl[0][6]; ?>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Email Id</td>
                                            ...
                                            <tr>
                                                <td>Gender </td>
                                                <td>:</td>
                                                <td class="text-start"><?php echo $cusDtl[0][7]; ?></td>
                                            </tr>
                                            <tr>
                                                <td>Profession</td>
                                                <td>:</td>
                                                <td class="text-start"><?php echo $cusDtl[0][14]; ?></td>
                                            </tr>
                                            <tr>
                                                <td>Phone No</td>
                                                <td>:</td>
                                                <td class="text-start"><?php echo $cusDtl[0][34]; ?></td>
                                            </tr>
                                            <tr>
                                                <td>Address </td>
                                                <td>:</td>
                            ...
                            <form class="form-horizontal" role="form" action="<?php echo $_SERVER['PHP_SELF'] ?>"
                                ...
                                <div class="form-group">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-xl-4">
                                            <input type="number" class="form-control" name="mobNumber"
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-xl-4 genderingrow ">
                                            <div class="form-check">
                                                <input class="form-check-input p-0" type="radio" name="gender"
                                                    value="male" <?php 
                                                                if ($cusDtl[0][7] == "male") {
                                                                    echo 'checked';
                                                                }
                                        ...
                                        <label for="txtProfession" class="col-xl-2 control-label">Profession</label>
                                        <div class="col-xl-4">
                            ...
                            <form class="form-horizontal mt-4" role="form" action="<?php echo $_SERVER['PHP_SELF'] ?>"
                                ...
                                <div class="form-group">
                                    <div class="row align-items-center">
                                        <label for="address1" class="col-xl-2 control-label">Address1</label>
                                        <div class="col-xl-4">
                                            <input type="text" class="form-control" name="address1"
                                                value="<?php echo $cusDtl[0][24]; ?>" required>
                                        </div>
                                        <label for="address2" class="col-xl-2 control-label">Address2</label>
                                        <div class="col-xl-4">
                                ...
                                <div class="form-group">
                                    <div class="row align-items-center">
                                        ...
                                        <!-- City Dropdown Start -->
                                        <label for="city" class="col-xl-2 control-label">City</label>
                                        <div class="col-xl-4">
                                        ...
                                        <label for="postal_code" class="col-xl-2 control-label">Postal Code</label>
                                        <div class="col-xl-4">
                                ...
                                <div class="form-group ">
                                    <div class="row align-items-center">
                                        <label for="country" class="col-xl-2 control-label">Country</label>
                                        <div class="col-xl-4">
                                            <select id="country" class="form-select " name="countryId" required>
                                        ...
                                        <label for="stateId" class="col-xl-2 control-label">State</label>
                                        <div class="col-xl-4">
                                ...
                                <div class="form-group">
                                    <div class="row align-items-center">
                                        <label for="phone1" class="col-xl-2 control-label">Phone1</label>
                                        <div class="col-xl-4">
                                            <input type="number" class="form-control" name="phone1"
                                                value="<?php echo $cusDtl[0][31]; ?>" required>
                                        </div>

                                        <label for="phone2" class="col-xl-2 control-label">Phone2</label>
                                        <div class="col-xl-4">
