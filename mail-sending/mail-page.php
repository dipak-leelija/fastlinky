...
function orderAccepted ($orderId, $firstName, $domain){
    ...
    $mail ="<tr>
                <td style='padding-bottom: 0px !important; padding: 2rem;'>
                    <h1 style='margin: 0; font-size: 22px; line-height: 1.1; font-weight: bold; letter-spacing: -0.02em; font-family: \"Cabin\", sans-serif;'>Hi {$firstName}, Your order has been place accepted</h1>
