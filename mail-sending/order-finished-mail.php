<?php
if (isset($orderId) && isset($toName) && isset($toMail) && isset($domain) && isset($contentTitle) && isset($publishedDate)):
    ...
    $subject        = "Your Order Is Completed - #{$domain}";
    $messageBody    = orderFinished($orderId, $firstName, $contentTitle, $publishedDate);
