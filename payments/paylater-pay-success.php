...
if (isset($_POST['data']) && isset($_POST['orderId'])) {
	...
	$clientOrderPrice 	= $orderDetail[0]['clientOrderPrice'];
	...
	if ($trxnStatus == "COMPLETED") {
		...
		$ContentOrder->contentOrderStatusUpdate($orderId, $trxn_id, $trxnStatus, $statusCode);
		...
		$ContentOrder->contentOrderStatusUpdate($orderId, $_SESSION['trxn_id'], $trxnStatus, $statusCode);
