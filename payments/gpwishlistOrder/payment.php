...
<body>
    ...
    <form method="post" name="customerData" action="pay-now.php" id="ccavForm">

        <input type="hidden" name="tid" id="tid" readonly />
        <input type="hidden" name="merchant_id"   value="284544" />
        <input type="hidden" name="order_id"      value="<?php echo $clientOrderData; ?>" />
        <input type="hidden" name="amount"        value="<?php echo $amountinInr; ?>" />
        <input type="hidden" name="currency"      value="INR" />
        <input type="hidden" name="redirect_url"  value="<?php echo URL; ?>/payments/gpwishlistOrder/paymentStatus.php" />
        <input type="hidden" name="cancel_url"    value="<?php echo URL; ?>/payments/gpwishlistOrder/paymentStatus.php" />
        <input type="hidden" name="language"      value="EN" />

        <input type="hidden" name="billing_name"      value="<?php echo $clientName;?>" />
        <input type="hidden" name="billing_address"   value="<?php echo $clientAddr;?>" />
        <input type="hidden" name="billing_city"      value="<?php echo $clientCity;?>" />
        <input type="hidden" name="billing_state"     value="<?php echo $clientState; ?>" />
        <input type="hidden" name="billing_zip"       value="<?php echo $clientzip; ?>" />
        <input type="hidden" name="billing_country"   value="India" />
        <input type="hidden" name="billing_tel"       value="<?php echo $clientContact; ?>" />
        <input type="hidden" name="billing_email"     value="<?php echo $clientEmail;?>" />

        <input type="hidden" name="delivery_name"     value="<?php echo $clientName;?>" />
        <input type="hidden" name="delivery_address"  value="<?php echo $clientAddr;?>" />
        <input type="hidden" name="delivery_city"     value="<?php echo $clientCity;?>" />
        <input type="hidden" name="delivery_state"    value="<?php echo $clientState; ?>" />
        <input type="hidden" name="delivery_zip"      value="<?php echo $clientzip; ?>" />
        <input type="hidden" name="delivery_country"  value="India" />
        <input type="hidden" name="delivery_tel"      value="<?php echo $clientContact; ?>" />

        <input type="hidden" name="merchant_param1"   value="<?php echo $_SESSION['userid']; ?>" />
        <input type="hidden" name="merchant_param2"   value="<?php echo $_SESSION['return_url']; ?>" />
        <input type="hidden" name="merchant_param3"   value="" />
        <input type="hidden" name="merchant_param4"   value="" />
        <input type="hidden" name="merchant_param5"   value="<?php echo $_SESSION['reorder-page']; ?>" />
