...
class MyError extends	Utility
{
	...
	*/
	function showErrorTA($action, $id, $id_var, $url, $msg, $typeM, $name){
		...
		//echo "Location: ".$url."?action=".$action."&typeM=".$typeM."&".$id_var."=".$id."&msg=".$msg."#".$name; exit;
		...
		if($id == 0){
			...
			//echo "Location: ".$url."?action=".$action."&typeM=".$typeM."&".$id_var."=".$id."&msg=".$msg."#".$name;
	...
	*	@return NULL
	*/
	function showErrorTA1($action, $id, $id_var, $url, $msg, $typeM, $name)
	{
		//echo "Location: ".$url."?action=".$action."&typeM=".$typeM."&".$id_var."=".$id."&msg=".$msg."#".$name; exit;
