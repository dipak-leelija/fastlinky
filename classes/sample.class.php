...
class Sample
{
	...
	*/
	...
	// //  $res = $this->conn->query("SELECT * FROM sample_db order by sample_id desc") or die(mysql_error());    
	//  $sqldal = "SELECT * FROM sample_db order by sample_id desc";

    //     $res = $this->conn->query($sqldal);
