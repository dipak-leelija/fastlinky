...
/**
*	This class is going to work with all Services associated with a different category. 
*
*	UPDATE July 29, 2019:
*	New function has been added to display services in different format in runtime. The 
...
class Services extends DatabaseConnection
{
	...
	*/
	...
	function editServicesCat($id,$cat_name, $desc, $modified_by)
	...
	*	@return array
	*/
	function getServiceCatDetail($id){
		//echo $id; exit;
		//declare var
		$data		= array();
		//statement
	...
	*/
	...
	public function ShowSercsData(){
     $temp_arr = array();
     $res = mysql_query("SELECT * FROM services order by added_on desc") or die(mysql_error());        
