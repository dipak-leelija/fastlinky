                                ...
                                <form class="form-horizontal" role="form" action="<?php echo $_SERVER['PHP_SELF'] ?>"
                                    ...
                                    <div class="edit-section">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <label for="txtPass" class="col-sm-3 control-label"> New
                                                    Password</label>
                                                <div class="col-sm-9">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <label for="txtCnfPass" class="col-sm-3 control-label">Confirm
                                                    Password</label>
                                                <div class="col-sm-9">
                                                    <input type="password" class="form-control" id="txtCnfPass"
                                                        name="txtCnfPass">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-sm-4 col-sm-offset-3">
                                                    <button type="submit" name="btnEditPass"
                                                        class="add-project">Change</button>
                                                </div>
                                                <div class="col-sm-4 col-sm-offset-3">
                                                    <button type="submit" name="btnCancel"
                                                        class="cancel-project">Cancel</button>
                                                </div>
                                            </div>
                                        </div>
