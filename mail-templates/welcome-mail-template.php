            ...
            <tr>
                <td align="center" style="padding:0;">
                    <table role="presentation"
                        style="width: 94%; max-width: 600px; border-spacing: 0; text-align: left; font-family: Arial, sans-serif; font-size: 16px; line-height: 22px;color: #363636;">
                        <!-- **************************  LOGO IMAGE SECTION ************************ -->
                        <tr>
                            <!--|| ts=table-second ||  -->
                            <td style="font-weight: bold;">
                                <h1
                                    style="margin: 0px; color: #843fa1; line-height: 140%; text-align: center; word-wrap: break-word; font-weight: normal; font-size: 25px;">
                                    <strong> Hi '.$fistName.'!</strong>
                                </h1>
                                <p>
                        ...
                        <tr>
                            <td class="ts-td2-text-div">
                                ...
                                <p class="ts-td2-text-div-p" style="text-align: left; padding-top: 12px;">
                                    <strong style="font-size: 14px;">Click on the verify button bellow or copy the link
                                        to another tab to verify your account:</strong>
                                </p>
                ...
                <td align="center" style="padding: 0;">
                    <table role="presentation"
                        ...
                        <tr>
                            <!--|| ts=table-second ||  -->
                            <td
                                style="padding: 15px 30px 0px 30px; text-align: center; font-size: 24px; background: aliceblue;">
                                <a href="#" style="text-decoration:none;">
                                    <img style="width: 270px; max-width: 100%; height: auto; border: none; text-decoration: none; color: #ffffff;"
                                        src="'.LOGO_WITH_PATH.'" width="300" alt="Logo">
                                </a>
                            </td>
                        </tr>
                        <!-- **************************  LOGO IMAGE SECTION ENDS ************************ -->
                        <tr style="background-color: #e7e7e74a;">
                            <td class="ts-td3-img-div" style="padding: 0; font-weight: bold;">
                                <img class="ts-td3-image" style="margin: auto;"
                                    src="'.URL.'/mail-templates/images/emails-img1.png" width="600" alt="">
                            </td>
                        </tr>
                        <tr>
                            <td class="ts-td2-text-div">
                                ...
                                <p class="ts-td2-text-div-p">Thanks '.$fastName.' for taking the time to verify your
                                    account on FastLinky. Your verification ensures that our community remains safe and
                                    secure for all users. Keep sharing and connecting with others on our platform!
                                </p>
                            </td>
                        </tr>
                        <tr style="background-color: #e7e7e74a;">
                            <td class="explore-section">
                                <div class="col-sml">
                                    <img class="col-sml-img" src="'.URL.'/mail-templates/images/email-verify.png"
                                        width="115" alt="">
                                </div>
                                <div class="col-lge">
                                    <p class="col-lge-p1">'.COMPANY_FULL_NAME.' use special strategy to increase your
                                        visibility and reach by publishing content on other websites. It involves
                                        writing and submitting articles or blog posts to be published on relevant
                                        websites in exchange for a link back to the author\'s website. </p>

                                    <p class="col-lge-p2" style="">This can help to increase website traffic, build
                                        brand awareness, and improve search engine rankings.</p>
                                    <p class="col-lge-p3">
                        ...
                        <tr>
                            <td class="ts-td6-text-div">
                                <p style="margin:0;">Beware of online fraud and scams. Always verify the authenticity of
                                    offers and transactions before providing personal or financial information. We are
                                    not responsible for any loss or damages resulting from any fraudulent activities.
                                </p>
                            </td>
                        </tr>';
...
<body class="clean-body u_body"
    style="margin: 0;padding: 0; word-spacing: normal; -webkit-text-size-adjust: 100%;background-color: #e7e7e7;color: #000000;">
                                        ...
                                        <div
                                                                ...
                                                                <tr>
                                                                    <td style="padding-right: 0px;padding-left: 0px;"
                                                                        ...
                                                                        <img align="center" border="0"
                                                                            src="'.LOGO_WITH_PATH.'" alt="" title=""
                                                                            style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 35%;max-width: 168px;"
                                                                            width="168" />
                                            ...
                                            <table id="u_content_heading_1"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            style="overflow-wrap:break-word;word-break:break-word;padding:2px 10px 1px;font-family:arial,helvetica,sans-serif;"
                                                            align="left">

                                                            <h2 class="v-color"
                                                                style="margin: 0px; color: #34495e; line-height: 140%; text-align: left; word-wrap: break-word; font-weight: normal; font-size: 18px;">
                                            ...
                                            <table style="font-family:arial,helvetica,sans-serif;" role="presentation"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            style="overflow-wrap:break-word;word-break:break-word;padding:0px 10px 2px;font-family:arial,helvetica,sans-serif;"
                                                            align="left">

                                                            <div class="v-color"
                                                                style="color: #34495e; line-height: 140%; text-align: left; word-wrap: break-word;">
                                                                <p style="font-size: 14px; line-height: 140%;">
                                                                    <strong><span style="line-height: 22.4px;">
                                                                            A new user has just registered. Their
                                                                            information has been captured and is ready
                                                                            for your review.</span></strong>
                                                                </p>
                                                            </div>
                            ...
                            <div
                                ...
                                <div id="u_column_2" class="u-col u-col-100"
                                    ...
                                    <div class="v-col-background-color"
                                        ...
                                        <!--[if (!mso)&(!IE)]><!-->
                                        <div
                                            style="height: 100%; padding: 0px;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;">
                                            <!--<![endif]-->
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div
                                                                style="margin-left:18px; font-family: Cabin, sans-serif;">
                                                                ';
                                                                foreach ($data as $d) {
                                                                $body .= '<p>'.$d.' : <b>'.array_shift($data_val).'</b>
                                                                </p>';
                                                                }
                                                                $body .= '</div>
                                                        </td>
                                            ...
                                            <table id="u_content_text_4" style="font-family:arial,helvetica,sans-serif;"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            style="overflow-wrap:break-word;word-break:break-word;padding:12px 10px 18px;font-family:arial,helvetica,sans-serif;"
                                                            align="left">

                                                            <div class="v-color"
                                                                style="line-height: 150%; text-align: left; word-wrap: break-word;">
                                                                <p style="font-size: 14px; line-height: 150%;"><span
                                                                        style="font-family: Cabin, sans-serif; font-size: 14px; line-height: 21px;">Please
                                                                        take a moment to review their account and ensure
                                                                        that everything is in order.</span></p>
                                                            </div>
                        ...
                        <div class="u-row"
                            ...
                            <div
                                ...
                                <div class="u-col u-col-100"
                                    style="max-width: 320px;min-width: 500px;display: table-cell;vertical-align: top;">
                                    <div class="v-col-background-color"
                                        style="background-color: #483fee;height: 100%;width: 100% !important;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;">
                                        <!--[if (!mso)&(!IE)]><!-->
                                        <div
                                            ...
                                            <table style="font-family:arial,helvetica,sans-serif;" role="presentation"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            style="color: #ffffff;overflow-wrap:break-word;word-break:break-word;padding:8px;font-family:arial,helvetica,sans-serif;font-weight: 600; font-size: 14ps;"
                                                            align="left">
