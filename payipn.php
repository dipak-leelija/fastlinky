...
//all the post vars
echo '<br>'.$txtName 		= $_SESSION['txtName'];
echo '<br>'.$txtEmail		= $_SESSION['txtEmail'];
echo '<br>'.$txtAddress		= $_SESSION['txtAddress'];

echo '<br>'.$txtCity		= $_SESSION['txtCity'];
echo '<br>'.$txtState		= $_SESSION['txtState'];
echo '<br>'.$txtPostalCode	= $_SESSION['txtPostalCode'];
echo '<br>'.$txtPhone		= $_SESSION['txtPhone'];
...
echo '<br>'.$orders_amount	= $_SESSION['ordAmt'];
echo '<br>'.$ordCode		= $_SESSION['ordCode'];
echo '<br>'.$ordId			= $_SESSION['ordId'];
