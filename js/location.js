...
function getProvinceList() {
    ...
    var url = "../includes/province_list.php?txtCountriesId=" + escape(txtCountriesId) + "&cus_id=" + escape(cus_id);
...
function getProvince() {
    ...
    if (request.readyState == 4) {
        ...
        if (request.status == 200) {
            ...
            // document.getElementById("showError").innerHTML = xmlResponse;
            // alert(xmlResponse);
...
function getProvinceListCounty() {
    ...
    //alert(escape(txtProvinceId))
    var url = "../includes/province_list.php?txtCountriesId=" + escape(txtCountriesId);
    request.open('GET', url, true);
...
//     request.onreadystatechange = getCity;
//     //send the request
//     request.send(null);
// }
...
function getCityByState(stateId) {
    ...
    var url = "../includes/town_option.php?stateId=" + escape(stateId) + "&cus_id=" + escape(cus_id);
    request.open('GET', url, true);
