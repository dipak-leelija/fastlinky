...
// ====================================== PayLater Emails ======================================
function paylaterPaymentMail($fromMail, $toMail, $toName, $subject, $txndtls_arr, $txndata_arr, $addedOn){
    ...
    <html lang="en" xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:v="urn:schemas-microsoft-com:vml">
        <head>
            ...
            <meta content="text/html; charset=utf-8" http-equiv="Content-Type" />
            <meta content="width=device-width, initial-scale=1.0" name="viewport" />
            <link href="https://fonts.googleapis.com/css2?family=Poppins:ital,wght@0,100;0,200;0,500;0,600;1,100;1,200&display=swap" rel="stylesheet">';
    ...
    $body .= '
        ...
        <body style="background-color: #f9f9f9; margin: 0; padding: 0; -webkit-text-size-adjust: none; text-size-adjust: none;">
                <table border="0" cellpadding="0" cellspacing="0" class="nl-container mso-space-0" role="presentation" style=" background-color: #f9f9f9;" width="100%">
                    <tbody>
                        <tr>
                            <td>';
                            ...
                            $body .= '<table align="center" border="0" cellpadding="0" cellspacing="0" class="row row-4 mso-space-0" role="presentation" style="" width="100%">
                                                                        ...
                                                                        <div style="font-family: Poppins\', sans-serif">
                                                                            <div class="txtTinyMce-wrapper" style=" font-family: Poppins, Arial, Helvetica Neue, Helvetica, sans-serif; mso-line-height-alt: 21px; color: #393d47; line-height: 1.5;">
                                                                                <p style="margin: 0; font-size: 16px; text-align: left;">
                                                                                    ...
                                                                                    <br>
                                                                                    <br>
                                                                                    New Paylater Payment Recived.
                                                                                    <br>
                                                                                    Payment Recived on<span> '.$addedOn.'.</span>
                                                                                    <br>
                                                                                    Please find the transection details below:
                    ...
                    $body .= '<table align="center" border="0" cellpadding="0" cellspacing="0" class="row row-7 mso-space-0" role="presentation" width="100%">
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="mso-space-0" style="background-color: #ffffff; width: 680px; font-weight: 400; font-size: 14px; font-family: Poppins, Arial, Helvetica Neue, Helvetica, sans-serif; mso-line-height-alt: 21px; color: #2f2f2f; line-height: 1.5; margin: 0px auto;padding: 20px; text-align: center;" width="680">
                                                ...
                                                <p style="margin: 0; font-size: 15px; margin-top: 5px;">
                                                    If you find anything wrong, please fix it and inform to the customer as soon as possible.
                                                </p>
                                                <p style="margin: 0; font-size: 13px; margin-top: 8px;">
                                                    This is an auto generated mail during transection on <a href="'.URL.'">leelija.com</a>
                                                </p>
                                            </div>
                                        </td>
                                    </tr>
