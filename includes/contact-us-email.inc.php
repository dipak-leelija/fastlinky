<?php 
	...
	*/	
	...
	define('ERCONTACT002', 'Provide Your Last Name');
	define('ERCONTACT003', 'Invalid email address');
	define('ERCONTACT004', 'Provide Your Budget');
	define('ERCONTACT005', 'Invalid website address');
	define('ERCONTACT006', 'Write the note for Contact');
	
	define('SUCONTACT001', 'Great, we will get in touch soon');	
