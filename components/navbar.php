            ...
            ?>
                ...
                <li class="nav-item dropdown dashboaard_button mobile_login_btn">
                    ...
                    <ul class="dropdown-menu  external-drop-menu">
                        <li> <a href="<?php echo URL; ?>/dashboard" class="dropdown-item  external-lis"><i class="fa fa-home pe-2"></i>Dashboard</a>
                        </li>
                        <li><a class="dropdown-item external-lis" href="<?php echo URL; ?>/logout"><i class="fa-solid fa-arrow-right-from-bracket pe-2"></i>Logout</a></li>
                    </ul>
                </li>
            <?php
            }
                    ...
                    <ul class="dropdown-menu producting-menues mydropdownmenu">
                        ...
                        <div class="row producting-divs-main-row">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                ...
                                <li><a class="dropdown-item  producting-menues-lis" href="<?php echo URL; ?>/white-label-link-building">WHITE LABEL LINK
                                        BUILDING</a>
                                </li>
                                <li><a class="dropdown-item  producting-menues-lis" href="<?php echo URL; ?>/high-authority-backlinks">HIGH
                                        AUTHORITY BACKLINKS</a></li>
                                <li><a class="dropdown-item  producting-menues-lis" href="<?php echo URL; ?>/country-specific-backlinks">COUNTRY SPECIFIC
                                        BACKLINKS</a>
                                </li>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                ...
                                <li><a class="dropdown-item  producting-menues-lis" href="<?php echo URL; ?>/link-insertion-service">LINK
                                        INSERTION SERVICE</a></li>


                                <li><a class="dropdown-item   producting-menues-lis" href="<?php echo URL; ?>/blogger-outreach">BLOGGER
                                        OUTREACH</a></li>
                                <li><a class="dropdown-item  producting-menues-lis" href="<?php echo URL; ?>/cannabis-backlinks">CANNABIS
                                        BACKLINKS</a></li>
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <li><a class="dropdown-item  producting-menues-lis" href="<?php echo URL; ?>/managed-link-building">MANAGED
                                        LINK BUILDING</a></li>
                                <li>
                                    <a class="dropdown-item  producting-menues-lis" href="<?php echo URL; ?>/guest-posting">GUEST
                                        POSTING</a>
                                </li>
                                <li><a class="dropdown-item  producting-menues-lis" href="<?php echo URL; ?>/casino-backlinks">CASINO
                                        BACKLINKS</a></li>
                            </div>
                        </div>
