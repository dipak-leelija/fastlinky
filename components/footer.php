            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <div class="widget subscribe no-box">
                        ...
                        <img src="<?php echo FOOTER_LOGO; ?>" alt="" width="<?php echo FL_WIDTH; ?>px">
                        <p class="quotings-for-footer-p mt-2">Objectively integrate enterprise wide strategic theme
                            areas
                            with functionalized
                            infrastructures. Interactively productize premium mobile technologies. </p>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-6 col-md-3">
