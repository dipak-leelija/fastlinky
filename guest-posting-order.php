 ...
 ?>
    <form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post" name="frmPaypal">
     ...
     <!--  >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><input type="hidden" name="shipping" 		value="0">-->
      ...
      <input type="hidden" name="return" 		value="http://localhost/leelija.in3.0/check.php">
      ...
      <img src="images/icons/loading.gif" width="220" height="19" alt="Page Loading. Please Wait..." />
      </div>
    </form>
