			...
			<div class="header-top text-md-left text-center">
				<div class="container">
					<div class="d-md-flex align-items-center justify-content-between">
						...
						</p><a href="http://api.whatsapp.com/send?phone=917003451378" target="_blank"><img src="images/icons/whatsapp.png" style="height:31px"><span style="color:#0673BA;position:relative;padding-left:5px">we are always there</span> </a>
						<ul class="social-iconsv2 agileinfo mt-md-0 mt-2">
							<li>
								<a class="dark-blue-color" href="mailto:info@leelija.com"><img src="images/icons/gmail.png" style="height:25px;position:relative;top:-2.5px">
								 	info@leelija.com
								</a>
							</li>
							<li>
								...
								<ul class="navbar-nav text-left">
									...
									<li class="nav-item dropdown mr-3">
										...
										<div class="dropdown-menu text-lg-left text-center" aria-labelledby="navbarDropdown">
											<a class="dropdown-item nav-link" href="domains.php">Blogs & Websites</a>
											<a class="dropdown-item nav-link" href="guest-posting.php">Guest Posting </a>
											<div class="dropdown-divider"></div>
											<a class="dropdown-item nav-link" href="#testi">Tools</a>
										</div>
									</li>
									<li class="nav-item">
									...
									<li class="nav-item  mr-3">
										<a class="nav-link" href="start-selling.php">Become a Seller</a>
									</li>
									<li class="nav-item">
									...
									<li class="nav-item dropdown mr-3">
										<a class="nav-link dropdown-toggle" href="dashboard.php" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true"
										    aria-expanded="false"> 
											My Account
										</a>
										<div class="dropdown-menu text-lg-left text-center" aria-labelledby="navbarDropdown">
